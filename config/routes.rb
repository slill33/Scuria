Rails.application.routes.draw do
  ...
  # backlog column
  match "/api/v1/private/backlogs/:id/backlog_columns/create.json", controller: :"private_api/backlog_columns", action: :create, format: false, via: [:post]
  match "/api/v1/private/backlogs/:id/backlog_columns/update.json", controller: :"private_api/backlog_columns", action: :update, format: false, via: [:put]
  match "/api/v1/private/backlogs/:id/backlog_columns/destroy.json", controller: :"private_api/backlog_columns", action: :destroy, format: false, via: [:delete]
  # backlog item
  match "/api/v1/private/backlogs/:id/backlog_items/create.json", controller: :"private_api/backlog_items", action: :create, format: false, via: [:post]
